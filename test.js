...
(async()=>{ 
    ...
    await requestHandler.handle(callingModule, { port: 3000, path: "/test", publicHost: "localhost", publicPort: 4000, username: "anonymous", passphrase: "anonymous", fromhost: "localhost", fromport: 6000 });
})().catch((err)=>{
    console.error(err);
});